...
- **items** ([]<a href="{{< ref "/docs/config-and-storage/secret-v1#secret" >}}">Secret</a>), required
...
##### Response
200 (<a href="{{< ref "/docs/config-and-storage/secret-v1#secret" >}}">Secret</a>): OK
401: Unauthorized
...
##### Response
200 (<a href="{{< ref "/docs/config-and-storage/secret-v1#secretlist" >}}">SecretList</a>): OK
401: Unauthorized
#### `list` list or watch objects of kind Secret
...
##### Parameters
  - **{namespace}** (string), required
    <a href="{{< ref "/docs/common-parameters/common-parameters-#namespace" >}}">namespace</a>
  - **body** (<a href="{{< ref "/docs/config-and-storage/secret-v1#secret" >}}">Secret</a>), required
...
##### Response
200 (<a href="{{< ref "/docs/config-and-storage/secret-v1#secret" >}}">Secret</a>): OK
201 (<a href="{{< ref "/docs/config-and-storage/secret-v1#secret" >}}">Secret</a>): Created
202 (<a href="{{< ref "/docs/config-and-storage/secret-v1#secret" >}}">Secret</a>): Accepted
401: Unauthorized
